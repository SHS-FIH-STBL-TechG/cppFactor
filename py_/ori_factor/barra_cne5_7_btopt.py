...
class barra_cne5_7_btopt(BaseFactor):
    factor_type = "DAY"
    ...
    def calc_single(self, database):
        ...
        def demean(ans):
            ...
            ind = ans_ind.groupby('swl1').median().reset_index()
            ...
            ans_ind1['ans_zscore'] = (ans_ind1[ans_ind1.columns[-3]] - ans_ind1[ans_ind1.columns[-2]]) / ans_ind1[ans_ind1.columns[-1]]
