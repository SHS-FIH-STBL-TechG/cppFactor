...
class m_vpc_mut_ty_log25(BaseFactor):
    #  定义因子参数
    ...
    def reform(self, temp_result):
        min_periods = self.decide_min_periods('std', 5)
        factor_values = rolling_process(temp_result, 'std', window=5, min_periods=min_periods)
