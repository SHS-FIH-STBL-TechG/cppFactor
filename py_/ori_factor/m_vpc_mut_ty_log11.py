...
class m_vpc_mut_ty_log11(BaseFactor):
    #  定义因子参数
#    ['FactorMinAccelerateStdRatio', {'ptype': 'std', 'Data_Base': ['play_minute_close'], 'play_day_lag': None, 'play_min_lag': 6, 'generator_lag': 10, 'type': 1400, 'drop_callauction': True}, 'F_D_Min1400_AccelerateStdRE_std10.h5'], 
...
#    fix_times = ["1000", "1030", "1100", "1300", "1330", "1400", "1430"]
    ...
    def calc_single(self, database):
        ...
        ans_df = abs(ans_df)
        ans_df = ans_df.std(axis=0) / ans_df.sum(axis=0)
        return ans_df
    ...
    def reform(self, temp_result):
        ...
        factor_values = Util.rolling_process(factor_values, self.ptype, window=self.reform_window, min_periods=1)
