...
class barra_cne5_1_beta3(BaseFactor):
    factor_type = "DAY"
    # 依赖的平台原始数据，包括FactorData和MarketData接口中的数据。 默认为空，必须设置
    depend_data = ["FactorData.Basic_factor.pct_chg", "FactorData.Basic_factor.a_mkt_cap",
                   "FactorData.Basic_factor.is_valid_test","FactorData.Basic_factor.pct_chg-000985.SH"]
    ...
    def calc_single(self, database):
        ...
        # rm = database.depend_data["FactorData.Basic_factor.pct_chg-000985.SH"].iloc[:,0] / 100
